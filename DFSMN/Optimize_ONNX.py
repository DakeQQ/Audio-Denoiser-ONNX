...
# Path Setting
original_folder_path = "/home/DakeQQ/Downloads/DFSMN_ONNX"                      # The fp32 saved folder.
optimized_folder_path = "/home/DakeQQ/Downloads/DFSMN_Optimized"                # The optimized folder.
model_path = os.path.join(original_folder_path, "DFSMN.onnx")                   # The original fp32 model name.
optimized_model_path = os.path.join(optimized_folder_path, "DFSMN.onnx")        # The optimized model name.
