...
onnx_model_A        = "/home/DakeQQ/Downloads/Deep_Echo_AEC_Optimized/Deep_Echo_AEC.onnx"   # The exported onnx model path.
...
ort_session_A = onnxruntime.InferenceSession(onnx_model_A, sess_options=session_opts, providers=ORT_Accelerate_Providers if ORT_Accelerate_Providers else ['CPUExecutionProvider'], provider_options=provider_options)
