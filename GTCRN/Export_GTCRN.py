...
INPUT_AUDIO_LENGTH = 5120               # Set for static axis export: the length of the audio input signal (in samples) is recommended to be greater than 5120 and less than 35840. Higher values yield better quality. It is better to set an integer multiple of the NFFT value.
