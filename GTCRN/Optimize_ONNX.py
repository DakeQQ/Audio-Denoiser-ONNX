"""Optimize the exported GTCRN ONNX model."""
...
ORIGINAL_FOLDER_PATH = str(_SCRIPT_DIR / "GTCRN_ONNX")
OPTIMIZED_FOLDER_PATH = str(_SCRIPT_DIR / "GTCRN_Optimized")

ENABLE_FP16 = False   # Works well
UPGRADE_OPSET = 0
