...
# Path Setting
original_folder_path = "/home/DakeQQ/Downloads/H_GTCRN_ONNX"                        # The fp32 saved folder.
optimized_folder_path = "/home/DakeQQ/Downloads/H_GTCRN_Optimized"                  # The optimized folder.
model_path = os.path.join(original_folder_path, "H_GTCRN.onnx")                     # The original fp32 model name.
optimized_model_path = os.path.join(optimized_folder_path, "H_GTCRN.onnx")          # The optimized model name.
