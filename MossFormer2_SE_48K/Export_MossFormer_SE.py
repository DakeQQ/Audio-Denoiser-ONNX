...
KEEP_ORIGINAL_SAMPLE_RATE = False       # If `False`, the model will output the 48K audio else original sample rate.
SAMPLE_RATE = 48000                     # [16000, 22500, 24000, 48000]; The MossFormer_SE parameter. It accepts various sample rate as inputs.
