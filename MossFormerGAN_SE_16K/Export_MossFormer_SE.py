...
# Fixed MossFormerGAN model and ONNX export parameters.
OPSET                = 20
...
MAX_SIGNAL_LENGTH    = 2048 if DYNAMIC_AXES else (((FOLD_WINDOW_LENGTH if USE_BATCH_FOLD else MODEL_AUDIO_LENGTH) + HOP_LENGTH - 1) // HOP_LENGTH + 1)
