...
# Path Setting
original_folder_path = "/home/DakeQQ/Downloads/NKF_AEC_ONNX"                        # The fp32 saved folder.
optimized_folder_path = "/home/DakeQQ/Downloads/NKF_AEC_Optimized"                  # The optimized folder.
model_path = os.path.join(original_folder_path, "NKF_AEC.onnx")                     # The original fp32 model name.
optimized_model_path = os.path.join(optimized_folder_path, "NKF_AEC.onnx")          # The optimized model name.
use_fp16 = False
target_opset = 0
