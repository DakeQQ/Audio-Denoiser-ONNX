...
onnx_model_A             = str(parent_path / "SDAEC_Optimized" / "SDAEC.onnx")       # The optimized onnx model path.
test_near_end_audio      = model_audio_path("sdaec", "near_end")                   # The near end audio path.
test_far_end_audio       = model_audio_path("sdaec", "far_end")                    # The far end audio path.
...
ORT_Accelerate_Providers   = []  # The mixed FP16 SDAEC graph is validated on CUDA. Use [] for CPU FP32 fallback.
