...
# Path Setting
original_folder_path = "/home/DakeQQ/Downloads/SDAEC_ONNX"                        # The fp32 saved folder.
optimized_folder_path = "/home/DakeQQ/Downloads/SDAEC_Optimized"                  # The optimized folder.
model_path = os.path.join(original_folder_path, "SDAEC.onnx")                     # The original fp32 model name.
optimized_model_path = os.path.join(optimized_folder_path, "SDAEC.onnx")          # The optimized model name.
use_fp16 = False                                                                  # CUDA + SDAEC-FP16 will cause bad AEC results.
target_opset = 0
