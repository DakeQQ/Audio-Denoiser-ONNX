"""Optimize the exported UniPASE ONNX pipeline."""
...
ORIGINAL_FOLDER_PATH = str(_SCRIPT_DIR / "Unipass_ONNX")
OPTIMIZED_FOLDER_PATH = str(_SCRIPT_DIR / "Unipass_Optimized")

# User config
QUANT_METHOD = "Q8"                     # "Q4" | "Q8" | "F16" | "F32"; validate Q4 output quality before deployment.
