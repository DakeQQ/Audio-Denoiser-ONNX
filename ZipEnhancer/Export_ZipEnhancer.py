...
# Fixed ZipEnhancer model and ONNX export parameters.
parent_path         = Path(__file__).resolve().parent
onnx_model_A        = str(parent_path / "ZipEnhancer_ONNX" / "ZipEnhancer.onnx")
...
MAX_SIGNAL_LENGTH     = 1024 if DYNAMIC_AXES else ((FOLD_WINDOW_LENGTH // HOP_LENGTH + 1) if USE_BATCH_FOLD else (MODEL_AUDIO_LENGTH // HOP_LENGTH + 1))
