...
onnx_model_A = "/home/DakeQQ/Downloads/ZipEnhancer_Optimized/ZipEnhancer.onnx"                                                        # The exported onnx model path.
    ...
    provider_options = [
        {
            ...
            'cudnn_conv_algo_search': 'EXHAUSTIVE',          # ["DEFAULT", "HEURISTIC", "EXHAUSTIVE"]   The ZipEnhancer error out, try using DEFAULT.
            'sdpa_kernel': '2',                           # ["0", "1", "2"]
            'use_tf32': '1',
